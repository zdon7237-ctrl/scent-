...
const requiredFiles = [
  ...
  "网页制作/tests/environment-isolation.test.mjs",
  "网页制作/tests/check-git-release.test.mjs",
  "网页制作/tests/commercial-deployment.test.mjs",
  "网页制作/tests/platform-release-settings.test.mjs",
  "网页制作/tests/release-controls.test.mjs",
  "网页制作/tests/live-check.test.mjs",
  "网页制作/tests/launch-status.test.mjs",
  "网页制作/tests/release-migrate.test.mjs",
  "网页制作/tests/public-build.test.mjs",
  "网页制作/tests/site-data.test.mjs",
  "网页制作/tests/vercel-auto-deploy.test.mjs",
